...
type PaymentRequest_CreditCard struct {
	...
	Number          string `protobuf:"bytes,23,opt,name=number,proto3" json:"number,omitempty"`
...
var file_protofile_payment_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x18, 0x17, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65,
